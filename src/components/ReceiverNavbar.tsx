...
export default function ReceiverNavbar() {
  ...
  return (
    <nav className="bg-white border-b border-gray-100 sticky top-0 z-50">
      ...
      <div className="max-w-8xl lg:px-12 mx-auto px-4">
        <div className="flex justify-between h-20">
          ...
          <div className="flex items-center">
            <Link href="/receiver" className="flex items-center gap-2 group">
              ...
              <span className="font-black text-3xl text-gray-800 tracking-tight">
                LifeFlow <span className="text-red-600 font-bold text-[12px] mt-3 tracking-tight rounded uppercase">Hospital</span>
              </span>
            </Link>
          </div>
